...
import { Sparkles, Lock, Mail, User, Loader2, ArrowRight } from 'lucide-react';
...
export default function RegisterPage({ setActivePage }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Move immediately to onboarding
    ...
    <div className="max-w-md mx-auto py-12 px-4 sm:px-6">
      <div className="bg-white rounded-3xl border border-slate-200 p-8 shadow-xl space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-xs text-slate-500">Join JobFusion AI to find opportunities tailored to you</p>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-slate-300 text-sm focus:outline-none focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500"
              />
            </div>
          </div>
